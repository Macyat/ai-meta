...
commands = [
    ...
    + compared_label,
    "python run_futian.py --location daojin --select 0 --compared_label " + compared_label,
    "python run_futian.py --location daojin --select 1 --compared_label " + compared_label,
